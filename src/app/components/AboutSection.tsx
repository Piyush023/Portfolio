        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Having accumulated over three years of front-end development experience, I specialize in 
                JavaScript, TypeScript, React.js, Next.js, and React Native. I believe in creating 
                exceptional digital experiences that make a difference.
              </p>
              <p>
                In my past roles, I've demonstrated a successful history of creating scalable applications 
                and enhancing user experience. I effectively utilize modern technologies to build responsive 
                user interface components and improve front-end performance.
              </p>
              <p>
                My expertise in API integrations, performance optimization, and state management allows me 
                to contribute significantly to development teams and deliver high-quality solutions.
              </p>
            </div>
          </motion.div>
